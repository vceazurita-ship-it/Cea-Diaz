...
export interface PenaltyResult {
  ...
  at: string;
  /**
   * **Dónde ha marcado**, zona a zona y en orden: `biad` es un gol abajo al
   * palo izquierdo y otro a la escuadra derecha.
   *
   * Se guarda porque Benji tiene memoria: se va a los sitios por los que ya
   * le han marcado, y repetir rincón deja de funcionar. Si esto no viajara
   * con la tanda, cerrar la aplicación le borraría la memoria y repetir el
   * mismo tiro cinco veces volvería a ser la mejor jugada.
   */
  spots?: string;
  /**
   * Los puntos de la tanda: la cuenta de arcade, que no es lo mismo que los
   * goles. Se guarda para que una tanda a medias no pierda lo hecho.
   */
  points?: number;
  /**
