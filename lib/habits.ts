...
const victorCategories: HabitCategory[] = [
  ...
  ),
  {
    ...
    label: 'Desarrollo Personal',
    icon: '✨',
    description: 'Lectura, escritura y máster: lo que se cultiva fuera del campo.',
    ...
    metrics: [
      ...
      },
      {
        ...
        weight: 1,
        focus: 'aprendizaje',
        help: 'Clase, estudio o entrega. Va por semanas: un día sin máster apenas resta.',
      },
      {
        id: 'formacion',
        label: 'Formación y podcast',
        icon: '🎧',
        type: 'duration',
        target: 30,
        min: 0,
        ...
        weight: 1,
        focus: 'aprendizaje',
        help: 'Curso, charla o podcast del oficio. Va por semanas: un día sin ello apenas resta.',
      },
  ...
  },
  {
    ...
    metrics: [
      ...
      // La cultura de equipo y el microciclo se apartaban en la semana y no
      // tenían contra qué comprobarse. Van con peso 1 y no 2 por lo mismo que
      // el máster: no tocan todos los días, y el día que no tocan no es un
      // hábito incumplido.
      {
        id: 'cultura_equipo',
        ...
        weight: 1,
        focus: 'aprendizaje',
        help: 'Analizarla y trabajarla: valores, normas y cómo se comporta el grupo.',
      },
      {
        id: 'microciclo',
        label: 'Microciclo planificado',
        icon: '🗓️',
        type: 'duration',
        target: 45,
        min: 0,
        ...
        weight: 1,
        focus: 'aprendizaje',
        help: 'Montar la semana del equipo y recoger lo que ha dejado la anterior.',
      },
  ...
  // La mitad de la semana de Víctor no es campo: es casa, hijos, pareja y
  // recados. Estaba apartada en la agenda —siete ratos de familia y cinco de
  // casa— y no tenía ni una casilla contra la que comprobarse, así que el plan
  // no podía decir nada de ella. Ahora sí.
  {
    id: 'vinculos',
    label: 'Casa y Vínculos',
    icon: '🏡',
    description: 'Los hijos, la pareja, la gente de uno y lo que la casa pide.',
    gradient: 'from-orange-400 to-rose-500',
    metrics: [
      {
        id: 'tiempo_hijos',
        label: 'Tiempo con Leo y Hugo',
        icon: '🧒',
        type: 'duration',
        target: 60,
        min: 0,
        ...
        weight: 2,
        focus: 'esfuerzo',
        help: 'Rato de verdad: juego, campo, deberes o paseo, con el móvil lejos.',
      },
      {
        id: 'tiempo_pareja',
        label: 'Tiempo con María',
        icon: '💞',
        type: 'duration',
        target: 30,
        min: 0,
        ...
        weight: 2,
        focus: 'esfuerzo',
        help: 'Los dos, sin pantallas. El módulo de Pareja lleva su propia cuenta.',
      },
      {
        id: 'gente_querida',
        label: 'Ver a la familia o a los amigos',
        icon: '👵',
        type: 'toggle',
        help: 'Padres, hermanos o amigos. Va por semanas: no toca todos los días.',
      },
      {
        id: 'tareas_casa',
        label: 'Mi parte de la casa',
        icon: '🧹',
        type: 'toggle',
        weight: 2,
        help: 'Lo que hoy me toca: cocina, colada, recogida. No es ayudar, es la mitad.',
      },
      {
        id: 'gestiones',
        label: 'Recados, compra y papeleo',
        icon: '🗂️',
        type: 'toggle',
        help: 'Lo que si no se hace se acumula. Va por semanas.',
      },
      {
        id: 'organizar_semana',
        label: 'La semana organizada',
        icon: '📆',
        type: 'toggle',
        help: 'Un rato el domingo: agenda, recados y quién lleva a quién.',
      },
    ],
  },
  {
    ...
    label: 'Economía',
    icon: '💶',
    description: 'Lo que entra, lo que sale y el rato de sentarse a mirarlo.',
    gradient: 'from-emerald-400 to-teal-600',
    metrics: [
      {
        id: 'gastos_apuntados',
        label: 'Gastos del día apuntados',
        icon: '🧾',
        type: 'toggle',
        weight: 2,
        help: 'Dos minutos por la noche. Lo que no se apunta el mismo día no se apunta.',
      },
      { id: 'sin_gasto_impulsivo', label: 'Sin compras impulsivas', icon: '🛑', type: 'toggle' },
      {
        id: 'cuentas',
        ...
        weight: 1,
        focus: 'aprendizaje',
        help: 'Cuentas, facturas, ahorro e inversión. Va por semanas: un día sin mirarlas apenas resta.',
      },
    ],
  },
];
